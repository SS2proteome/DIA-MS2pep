...
## Data processing step by step (Here we suppose “demo_DIA.raw” as an example file of DIA data)
...
## One step run with *DIA_MS2pep_runner.sh* (DIA-MS2pep/Scripts/DIA-MS2pep_run) 

The configurat file is *demo_DIA_MS2pep.params* (DIA-MS2pep/Scripts/DIA-MS2pep_run). 

`DIA_MS2pep_runner.sh demo_DIA_MS2pep.params`
