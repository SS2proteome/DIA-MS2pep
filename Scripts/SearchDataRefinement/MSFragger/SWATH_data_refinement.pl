...
# my $pepxmlfile = "$dir/".$ARGV[4];

my @mgffiles = glob "$dir/w_[0-9]*_".$filename.".mgf"; #glob "tmp_[0-9]*_$file.mgf";
...
print Dumper \@mgffiles,\@pepxmlfiles;
...
#print Dumper \%ms1_file_position;exit;
